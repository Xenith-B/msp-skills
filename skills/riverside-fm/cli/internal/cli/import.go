...
but do not stop the import.`,
  ...
  riverside-fm-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  riverside-fm-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | riverside-fm-cli import <resource> --input -`,
