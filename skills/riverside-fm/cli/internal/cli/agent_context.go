...
func buildAgentContext(rootCmd *cobra.Command) agentContext {
	...
	return agentContext{
		...
		CLI: agentContextCLI{
			Name:        "riverside-fm-cli",
			Description: "The first programmatic way to download every transcript, audio track, and video from your own Riverside.com account...",
...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://riverside.com/dashboard",
		EntryCount:    76,
		APIEntryCount: 76,
		...
		CandidateCommands: []string{
			"create_logs — Derived from observed POST /api/logs traffic.",
			"create_migrate — Derived from observed POST /api/v4/global-search/migrate traffic.",
			"get_assets — Derived from observed GET /api/v4/take/{uuid}/assets traffic.",
			"get_clip_assets — Derived from observed GET /api/v4/take/{uuid}/clip/69fcda9fba030a19ae93a63c/clip-assets traffic.",
			"get_damienstevens_fqd4a6ckh — Derived from observed GET /api/v4/vod/{uuid}/damienstevens-fqd4a6ckh traffic.",
			"get_damienstevens_lmb0ml5mk — Derived from observed GET /api/v4/vod/{uuid}/damienstevens-lmb0ml5mk traffic.",
			"get_damienstevens_ms1to36g5 — Derived from observed GET /api/v4/vod/{uuid}/damienstevens-ms1to36g5 traffic.",
			"get_damienstevens_nev5txur8 — Derived from observed GET /api/v4/vod/{uuid}/damienstevens-nev5txur8 traffic.",
		},
	}
}
