...
large datasets as it has no memory pressure.`,
  ...
  riverside-fm-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  riverside-fm-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  riverside-fm-cli export <resource> --format jsonl | jq '.id'`,
