#!/usr/bin/env bash
# install.sh - install riverside-fm-cli and riverside-fm-mcp on macOS / Linux.
#
...
SKILL="riverside-fm"
CLI_BIN="riverside-fm-cli"
MCP_BIN="riverside-fm-mcp"
...
# Each skill is versioned and tagged independently (riverside-fm-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/riverside-fm#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/riverside-fm/mcp-install.md"
